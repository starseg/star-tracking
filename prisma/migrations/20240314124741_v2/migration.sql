...
-- AddForeignKey
ALTER TABLE `FleetContact` ADD CONSTRAINT `FleetContact_fleetId_fkey` FOREIGN KEY (`fleetId`) REFERENCES `Fleet`(`fleetId`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `FleetEmail` ADD CONSTRAINT `FleetEmail_fleetId_fkey` FOREIGN KEY (`fleetId`) REFERENCES `Fleet`(`fleetId`) ON DELETE RESTRICT ON UPDATE CASCADE;
